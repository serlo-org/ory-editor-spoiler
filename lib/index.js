		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'ory-plugins-layout-spoiler-toggle', onClick: this.onToggle },
						...
						readOnly ? state.title : _react2.default.createElement(_TextField2.default, { className: 'ory-plugins-layout-spoiler-toggle-title', disabled: readOnly,
							onChange: function onChange(e) {
								return _onChange({ title: e.target.value });
							}, value: state.title, hintText: 'Your Title Here', floatingLabelText: 'Title' })
					),
					_react2.default.createElement(
						'div',
