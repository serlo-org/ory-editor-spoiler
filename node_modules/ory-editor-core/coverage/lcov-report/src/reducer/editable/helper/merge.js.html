...
<html lang="en">
<head>
    <title>Code coverage report for src/reducer/editable/helper/merge.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/reducer/editable/helper</a> merge.js
    </h1>
    <div class='clearfix'>
...
export const mergeRows = (state: Row[]) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (state.length &lt; 2) {
...
export const splitRows = (state: Row[]) =&gt; (
  flatten(map(
    (row: Row) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!row.cells) {
<span class="cstat-no" title="statement not covered" >        return [row]</span>
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (row.cells.length !== 1) {
<span class="cstat-no" title="statement not covered" >        return [row]</span>
      }
&nbsp;
...
export const mergeDecorator = (action: Object) =&gt; (state: Row[]) =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (action.type !== SET_DISPLAY_MODE) {
    return state
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  switch (action.mode) {</span>
    case 'edit':
<span class="cstat-no" title="statement not covered" >      return mergeRows(state)</span>
    case 'insert':
    case 'layout': {
<span class="cstat-no" title="statement not covered" >      return splitRows(state)</span>
    }
    default:
<span class="cstat-no" title="statement not covered" >      return state</span>
  }
