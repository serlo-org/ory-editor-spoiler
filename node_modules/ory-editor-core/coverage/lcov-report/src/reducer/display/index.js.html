...
<html lang="en">
<head>
    <title>Code coverage report for src/reducer/display/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/reducer/display</a> index.js
    </h1>
    <div class='clearfix'>
...
export const display = (state: Display = {
  ...
  switch (action.type) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case SET_PREVIOUS_DISPLAY_MODE:</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
        ...state,
        mode: state.previous === state.mode ? action.fallback : state.previous
      }
<span class="branch-1 cbranch-no" title="branch not covered" >    case SET_DISPLAY_MODE:</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
